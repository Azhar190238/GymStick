        ...
        <div className='max-w-[1320px] mx-8 lg:mx-auto'>
            <div className='flex w-full flex-col lg:flex-row gap-6'>
                <div className='w-full lg:w-2/5'>
                    <div className='lg:max-w-[536px] flex flex-col space-y-10 mb-[60px]'>
                    ...
                    <div className='w-full lg:max-w-[536px] flex flex-col space-y-10'>
                ...
                <div className='w-[3/5] hidden md:flex flex-col md:flex-row gap-6'>
