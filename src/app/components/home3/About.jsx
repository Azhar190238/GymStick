...
const About = () => {
    const banners = [
        { title: "Boxing" ,image:"/images/Home3/1.png" }, { title: "Cycling" ,image:"/images/Home3/2.png"  },
        { title: "Workout" ,image:"/images/Home3/3.png" },  { title: "Boxing"  ,image:"/images/Home3/1.png" },       
        { title: "Cycling"  ,image:"/images/Home3/2.png" },  { title: "Workout"  ,image:"/images/Home3/3.png" },
        { title: "Boxing" ,image:"/images/Home3/1.png" }, { title: "Cycling" ,image:"/images/Home3/2.png"  },
        { title: "Workout" ,image:"/images/Home3/3.png" },  { title: "Boxing"  ,image:"/images/Home3/1.png" },       
        { title: "Cycling"  ,image:"/images/Home3/2.png" },  { title: "Workout"  ,image:"/images/Home3/3.png" },
    ];
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            setActiveSlide((prevSlide) => 
                prevSlide === totalSlides - slidesPerView ? 0 : prevSlide + 1
            );
        }, 2000); 

        return () => clearInterval(interval); 
    }, [activeSlide, slidesPerView, totalSlides]);
